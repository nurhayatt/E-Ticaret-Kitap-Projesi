                             ...
                             <div class="col-sm">
                                 <div class="mb-4">
                                     <button type="button" class="btn btn-light waves-effect waves-light">
                                         <a href="{{ route('superadmin.channel.add', $custom_streams_id) }}"><i
                                                 ...
                                                 <div class="dropdown">
                                                     ...
                                                     <ul class="dropdown-menu dropdown-menu-end">
                                                         <li><a class="dropdown-item"
                                                                 href="{{ route('superadmin.channel.edit', ['id' => $item->id]) }}">Edit</a>
                                                         </li>
                                                         <li>
                                                             <form
                                                                 action="{{ route('superadmin.channel.delete', ['id' => $item->id]) }}"
                                                                 method="POST">
                                                                 @csrf
                                                                 <button type="submit"
