                                         ...
                                         <div class="modal-dialog modal-dialog-centered" role="document">
                                             <div class="modal-content">
                                                 ...
                                                 <form enctype="multipart/form-data"
                                                     action="{{ route('superadmin.custom.add.post') }}" method="POST">
                                                     @csrf
                                 ...
                                 <tbody>
                                     @foreach ($projects as $item)
                                         <tr>
                                             <td>
                                                 #<a
                                                     href="{{ route('superadmin.channel.add', $item->id) }}">{{ $item->id }}</a>
                                             </td>
                                             <td><a href="javascript: void(0);" class="text-dark fw-medium">

                                                     <a href="{{ route('superadmin.channel.list', $item->id) }}">
                                                         {{ $item->project_name }}</a>
                                                 ...
                                                 <div class="dropdown">
                                                     ...
                                                     <ul class="dropdown-menu">
                                                         <li><a class="dropdown-item"
                                                                 href="{{ route('superadmin.custom.edit', ['id' => $item->id]) }}">Edit</a>
                                                         </li>
                                                         <li>
                                                             <form
                                                                 action="{{ route('superadmin.custom.delete', ['id' => $item->id]) }}"
                                                                 method="POST">
                                                                 @csrf
                                                                 <button type="submit"
