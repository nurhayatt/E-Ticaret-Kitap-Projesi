                                         ...
                                         <div class="modal-dialog modal-dialog-centered" role="document">
                                             <div class="modal-content">
                                                 ...
                                                 <form enctype="multipart/form-data"
                                                     action="{{ route('superadmin.buckets.add.post') }}" method="POST">
                                                     @csrf
                                         ...
                                         <tr>
                                             ...
                                             <td>
                                                 <a href="javascript: void(0);" class="text-dark fw-medium">
                                                     <a href="{{ route('superadmin.buckets.channel.list', $item->id) }}">
                                                         {{ $item->bucket_name }}
                                                     </a>
                                                 </a>
                                             </td>
                                                     ...
                                                     <ul class="dropdown-menu">
                                                         <li>
                                                             <a class="dropdown-item"
                                                                 href="{{ route('superadmin.buckets.edit', ['id' => $item->id]) }}">
                                                                 Edit
                                                             </a>
                                                         </li>
                                                         <li>
                                                             <form
                                                                 action="{{ route('superadmin.buckets.delete', ['id' => $item->id]) }}"
                                                                 method="POST">
                                                                 @csrf
                                                                 <button type="submit"
