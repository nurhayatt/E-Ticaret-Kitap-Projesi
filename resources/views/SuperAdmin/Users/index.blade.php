@extends('layouts.master')@section('title', 'Users') @section('content')
                        ...
                        <tr>
                            ...
                            <td>
                                <input data-id="{{ $item->id }}" class="toggle-class" type="checkbox"
                                    ...
                                    data-off="InActive" {{ $item->is_active ? 'checked' : '' }}>
                            </td>
                            <td>
                                <div class="dropdown">
                                    <button
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item"
                                                href="{{ route('superadmin.users.edit', ['id' => $item->id]) }}">Edit</a>
                                        </li>
                                        <li>
                                            <form action="{{ route('superadmin.users.delete', ['id' => $item->id]) }}"
                                                method="POST">
                                                @csrf
