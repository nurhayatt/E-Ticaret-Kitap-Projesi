                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="{{ route('superadmin.dashboard') }}" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src={{ asset("assets/images/logo-sm3.jpg") }} alt="" height="90%">
                                </span>
                                <span class="logo-lg">
                                    <img src={{asset("assets/images/logo-sm3.png")}} alt="" height="90%" width="90%"> 
                                </span>
                            </a>

                            <a href="{{ route('superadmin.dashboard') }}" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src={{ asset("assets/images/logo-sm3.svg") }} alt="" height="90%">
                                </span>
                                <span class="logo-lg">
                                    <img src={{asset("assets/images/logo-sm3.jpg")  }} alt="" height="90%"> <span class="logo-txt"></span>
                                </span>
                            </a>
                        </div>
                    ...
                    <div class="d-flex">
                        ...
                        @else
                         ...
                         <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <!-- item-->
                                <a class="dropdown-item" href="{{ route('superadmin.profile') }}"><i class="mdi mdi-face-profile font-size-16 align-middle me-1"></i> Profile</a>
                                <a class="dropdown-item" href=""><i class="mdi mdi-lock font-size-16 align-middle me-1"></i> Lock screen</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{ route('logout') }}"><i class="mdi mdi-logout font-size-16 align-middle me-1"></i> Logout</a>
                            </div>
