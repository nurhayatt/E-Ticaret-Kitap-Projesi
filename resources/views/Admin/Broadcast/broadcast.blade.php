                                         ...
                                         <div class="modal-dialog modal-dialog-centered" role="document">
                                             <div class="modal-content">
                                                 ...
                                                 <form enctype="multipart/form-data"
                                                     action="{{ route('admin.broadcast.add.post') }}" method="POST">
                                                     @csrf
                                     ...
                                     @foreach ($projects as $item)
                                         <tr>
                                             ...
                                             <td><a href="javascript: void(0);" class="text-dark fw-medium">
                                                     <a href="{{ route('admin.broadcast.channel.list', $item->id) }}">
                                                         {{ $item->project_name }}</a>
                                                 ...
                                                 <div class="dropdown">
                                                     ...
                                                     <ul class="dropdown-menu dropdown-menu-end">
                                                         <li><a class="dropdown-item"
                                                                 href="{{ route('admin.broadcast.edit', ['id' => $item->id]) }}">Edit</a>
                                                         </li>
                                                         <li>
                                                             <form
                                                                 action="{{ route('admin.broadcast.delete', ['id' => $item->id]) }}"
                                                                 method="POST">
                                                                 @csrf
                                                                 <button type="submit"
